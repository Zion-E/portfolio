...
function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:idowuakinsanmi599@gmail.com?subject=
  ...
  return (
    ...
    max-w-7xl px-10 justify-evenly mx-auto items-center">
        <h3 className="absolute top-1 mb-5 uppercase tracking-[20px] text-gray-500 text-2xl">
            Contact
        </h3>

        <div className="flex flex-col space-y-10">
            <h4 className="mt-8 text-4xl font-semibold text-center mx-auto">
                I have got just what you need.
                
                {/* {" "}
                <span className="decoration-[#f7ABBA]/50 underline-offset-2">Let's talk</span> */}
            </h4>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col space-y-2 w-fit mx-auto">
              ...
              <button 
              type='submit' 
              className="bg-[#F7ABBA] py-5 px-10 rounded-md text-black font-bold
              text-lg">
                Submit
              </button>
            </form>
